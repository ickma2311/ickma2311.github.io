...
The Fall 2026 schedule labels this topic **Lecture 8: Normalization, Dropout, + Implementation**. Its linked public recording and slides are from Fall 2022, when the recording was **Lecture 9: Normalization and Regularization**. This article explains the 2022 lecture material, not a separate 2026 implementation lecture. The small matrix and dropout calculations below are teaching examples.
