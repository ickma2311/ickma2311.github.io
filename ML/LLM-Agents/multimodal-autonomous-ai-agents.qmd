...
This note follows the March 2025 lecture rather than later model releases. The original note was prepared from the available transcript and slides, not continuous viewing of the recording. This revision checks the search and InSTA explanations against the relevant slides and linked research.
...
- [Lecture recording — Ruslan Salakhutdinov](https://www.youtube.com/watch?v=RPINOYM12RU), full transcript reviewed.
