...
::: {.section-block}
### ∫ Calculus <span class="section-count">11 notes</span>
...
::: {.content-card}
**[Gilbert Strang's Calculus: Chains and the Chain Rule](Math/Calculus/chain-rule.qmd)**
Chain rule for composite functions with clean examples, delta-ratio intuition, and Gaussian first/second derivatives via chain + product rules.
:::
