...
::: {.content-card}
**[Lecture 35: Find Clusters in Graph](mit18065-lecture35-find-clusters-graph.qmd)**
...
::: {.content-card}
**[Lecture 34: Distance Matrices, Procrustes Problem](mit18065-lecture34-distance-matrices-procrustes.qmd)**
...
::: {.content-card}
**[Lecture 32: The Convolution Rule](mit18065-lecture32-convolution-rule.qmd)**
...
::: {.content-card}
**[Lecture 31: Eigenvectors of Circulant Matrices, Fourier Matrix](mit18065-lecture31-fourier-matrix.qmd)**
...
::: {.content-card}
**[Lecture 30: Completing a Rank-1 Matrix, Circulants](mit18065-lecture30-completing-rank1-circulants.qmd)**
...
::: {.content-card}
**[Lecture 27: Back Propagation and Partial Gradients](mit18065-lecture27-backpropagation-partial-gradients.qmd)**
...
::: {.content-card}
**[Lecture 26: Structure of Neural Nets for Deep Learning](mit18065-lecture26-structure-of-neural-nets.qmd)**
...
::: {.content-card}
**[Lecture 25: Stochastic Gradient Descent](mit18065-lecture25-stochastic-gradient-descent.qmd)**
...
::: {.content-card}
**[Lecture 24: Linear Programming and Two-Person Games](mit18065-lecture24-linear-programming-two-person-games.qmd)**
Standard-form LP, simplex versus interior-point methods, primal-dual derivation, max-flow=min-cut, and why zero-sum games are linear programs in disguise.
:::

::: {.content-card}
**[Lecture 23: Accelerating Gradient Descent (Momentum)](mit18065-lecture23-accelerating-gradient-descent-momentum.qmd)**
Ill-conditioned valleys, heavy-ball momentum dynamics, eigen-direction recurrence analysis, the sqrt(kappa) acceleration result, and Nesterov look-ahead updates for earlier correction.
:::

::: {.content-card}
**[Lecture 22: Gradient Descent](mit18065-lecture22-gradient-descent.qmd)**
Gradient descent through quadratic geometry: Hessian-based convexity, line-search step-size rules, and why condition number controls zigzagging versus fast convergence.
:::

::: {.content-card}
**[Lecture 21: Minimizing a Function](mit18065-lecture21-minimizing-function.qmd)**
Taylor expansion introduces Hessian/Jacobian roles, Newton method updates for root finding and optimization, quadratic convergence intuition, and why full Newton is expensive in deep learning; ends with convex-set/function conditions and global-minimum guarantees.
:::
...
::: {.content-card}
**[Lecture 15: Matrix Derivatives and Eigenvalue Changes](mit18065-lecture15-matrix-derivatives.qmd)**
Differentiate the inverse with $\dot A^{-1}=-A^{-1}\dot A A^{-1}$, and track eigenvalue motion via $\dot\\lambda=y^\top \dot A x$. Low-rank PSD updates interlace eigenvalues, bounding how far each can move in the ordering.
:::

::: {.content-card}
**[Lecture 16: Derivative of Inverse and Singular Values](mit18065-lecture16-derivative-inverse-singular-values.qmd)**
Matrix derivatives require order-sensitive product rules. The singular value derivative is $\dot\sigma=u^\top \dot A v$, Weyl’s inequality bounds eigenvalue shifts, and nuclear norm minimization relaxes rank for matrix completion.
:::

::: {.content-card}
**[Lecture 17: Rapidly Decreasing Singular Values](mit18065-lecture17-rapidly-decreasing-singular-values.qmd)**
Rapid singular-value decay makes a matrix effectively low rank. This lecture connects numerical rank, image compression, Hilbert/Vandermonde examples, and Sylvester equations via spectral separation.
:::

::: {.content-card}
**[Lecture 18: Counting Parameters in SVD, LU, QR, and Saddle Points](mit18065-lecture18-counting-parameters-svd-lu-qr-saddle-points.qmd)**
How LU/QR/eigendecomposition/SVD split degrees of freedom, with parameter checks for each case. Ends with saddle points from KKT systems and Rayleigh quotients.
:::

::: {.content-card}
**[Lecture 19: Saddle Point and the Max–Min Principle](mit18065-lecture19-saddle-point-maxmin-principle.qmd)**
Stationary points of the Rayleigh quotient are eigenvectors: max, min, and saddle values. The Courant–Fischer max–min principle interprets intermediate eigenvalues. Ends with polynomial interpolation overfitting and a quick probability refresher on variance and covariance.
:::

::: {.content-card}
**[Lecture 20: Probability Definitions and Inequalities](mit18065-lecture20-probability-definitions-inequalities.qmd)**
Variance as E[X^2]-(E[X])^2, distribution-free bounds via Markov and Chebyshev, and the bridge from joint probability tables to covariance matrices.
:::
