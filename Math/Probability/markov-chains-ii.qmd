...
![Stationarity does not imply convergence: the period-two chain oscillates from a fixed state, while the aperiodic chain converges to (2/7, 5/7). Dotted lines show stationary starts. Exact matrix powers, not sampled paths.](markov-ii-01-stationarity-vs-convergence.png)
...
![Occupancy and probability flow: stationary probabilities are 2/7 and 5/7, but both cross-state flows equal 1/7 per step. Self-transitions supply the remaining incoming flow.](markov-ii-02-occupancy-and-flow.png)
...
![Finite birth–death example with capacity 4, upward probability 0.2 and downward probability 0.4. Local balance gives stationary probabilities (16, 8, 4, 2, 1)/31.](markov-ii-03-birth-death-boundary.png)
...
- [MIT lecture recording: 17. Markov Chains II](https://www.youtube.com/watch?v=ZulMqrvP-Pk), John Tsitsiklis.
- [Official transcript](https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/ZulMqrvP-Pk_transcript.pdf).
- [Official slides](https://ocw.mit.edu/courses/6-041sc-probabilistic-systems-analysis-and-applied-probability-fall-2013/0c0f13321d15596341420d11ce07fcc7_MIT6_041SCF13_L17.pdf). These resources are hosted in MIT's 6.041SC materials; the recording is linked as MIT 6.041.
- The slides assign textbook Section 7.3; this article focuses on the lecture and its explicitly identified derivations and numerical extensions.
