...
The explicit recurrence solution and simplified closed-class example below extend the lecture's calculations; they are worked examples, not results quoted from the slides.
...
- [Lecture recording](https://www.youtube.com/watch?v=IkbkEtOOC1Y).
